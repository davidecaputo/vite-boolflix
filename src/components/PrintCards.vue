<template>
    ...
    <div class="row">
        <div v-for="(film, index) of store.film" :key="film.id" class="col-12 col-sm-6 col-md-4 col-lg-3">
            <div class="card mb-4 w-100 h-100">
                <img :src="store.imageUrl + film.poster_path" alt="" v-if="film.poster_path">
                ...
                <div class="card-body">
                    ...
                    <p class="fi" :class="(film.original_language === 'en')?'fi-us' : 'fi-' + film.original_language"></p>
        ...
        <div v-for="(serie, index) of store.serieTv" :key="serie.id" class="col-12 col-sm-6 col-md-4 col-lg-3">
            <div class="card mb-4 w-100 h-100">
                ...
                <div class="card-body">
                    ...
                    <p class="fi" :class="(serie.original_language === 'en')?'fi-us' : 'fi-' + serie.original_language"></p>
